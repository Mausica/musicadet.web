...
echo "   musicadet                              # full update (scan + top tracks + cap trim)"
echo "   musicadet download-pending             # download top viewed only (auto-trims first)"
echo "   musicadet reconcile                    # refresh files + enforce caps"
